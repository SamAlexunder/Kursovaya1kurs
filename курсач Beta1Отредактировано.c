...
void bar3();  void bar4();int check0();int check1();
int check2(); void del(); void rod1(); void rod2();
void box1();void box2();void tee1();int voidtee2();
void tee3();void tee4();int check3();void insert();
void again();void print();int remove();void frame();
int DETECT;
            ...
            while(1)
                {
                    ...
                    do{
                    k=0;
                    if(kbhit()){ ch=system("pause");
                    if(ch==0) ch=system("pause");
